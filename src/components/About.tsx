    ...
    <section id="about" className="section-spacing bg-ivory relative overflow-hidden">
      ...
      <div className="section-container relative z-10">
        ...
        <div className="section-header animate-slide-up">
          <p className="section-header-label">OUR HERITAGE</p>
          <h2 className="section-header-h2">Artisan Stories, Woven Together</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div className="animate-slide-up order-2 md:order-1" style={{ animationDelay: '200ms' }}>
            <div className="relative aspect-[4/3] rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-700 border border-charcoal/5 group">
              ...
              {/* Floating stat badge */}
              <div className="absolute bottom-6 left-6 bg-white/95 backdrop-blur-sm rounded-lg shadow-lg p-4 border border-charcoal/8">
                <p className="text-2xl font-serif font-bold text-wine-red mb-1">100+</p>
                <p className="text-xs text-charcoal/65 uppercase tracking-wide font-medium">Master Artisans</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center animate-slide-up order-1 md:order-2" style={{ animationDelay: '300ms' }}>
            <h3 className="heading-lg text-maroon mb-8">Every Stitch Tells a Story</h3>

            <p className="body-lg text-charcoal/75 mb-8 leading-relaxed">
            ...
            <p className="body-base text-charcoal/65 mb-12 leading-relaxed">
              ...
              {[
                ...
                <div key={index} className="flex gap-4">
                  <div className="flex-shrink-0 mt-1">
                    <div className="w-3 h-3 rounded-full bg-wine-red/80"></div>
                  </div>
                  <div>
                    <h4 className="heading-sm text-charcoal mb-2">{item.title}</h4>
